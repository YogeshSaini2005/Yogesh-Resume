        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Curious coder and passionate problem-solver, ready to turn ideas into impactful software. Equipped with hands-on skills in **C#.NET, React, HTML, CSS, Docker, Kubernetes, and CI/CD**, I aim to craft clean, efficient, and scalable solutions. Eager to collaborate, innovate, and grow as a Software Engineer, while building technology that makes a difference.
            </p>
